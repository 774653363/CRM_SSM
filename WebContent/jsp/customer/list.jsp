										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>
														<button onclick="to_page(1)">筛选 </button>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${c.cust_mobile }</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/editCustomer?cust_id=${c.cust_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/deleteCustomer?cust_id=${c.cust_id}&pageSize=${page.pageSize}">删除</a>
													</TD>
												</TR>
												</c:forEach>
